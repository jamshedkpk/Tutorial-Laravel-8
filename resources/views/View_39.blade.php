...
<a href="#" class="update" id="{{$dept['department_id']}}" data-toggle="modal" data-target="#modalupdate">
Update	
</a>
</td>
<td>
...
@csrf
<div class="form-group">
<label for="name">Enter New Department Name :</label>   
<div id="newdept">
...
// Start of show record for updation
...
if(response)
{	
var id=response['data'].department_id;
var name=response['data'].department_name;
$result=$('#newdept').html(
'<input type="hidden" id="newdeptid" class="form-control" value=" '+id+' "></input><input id="newdeptname" type="text" class="form-control" value=" '+name+' "></input>'
...
// End of show record for updation

// Start of update record
$('#btnupdate').click(function(e){
event.preventDefault();
var id=$('#newdeptid').val();
